...
<div class="detalle-pedido-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'idDetallePedido' => $model->idDetallePedido], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'idDetallePedido' => $model->idDetallePedido], [
